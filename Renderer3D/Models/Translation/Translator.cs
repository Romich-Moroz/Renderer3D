...
namespace Renderer3D.Models.Translation
{
    ...
    public static class Translator
    {
        ...
        public static Vector4 Move(this Vector4 objectVertex, Vector3 locationOffset)
        {
            return objectVertex.Translate(CreateMovingMatrix(locationOffset));
        }
        ...
        public static Vector4 Scale(this Vector4 objectVertex, Vector3 scale)
        {
            return objectVertex.Translate(CreateScaleMatrix(scale));
        }
        ...
        public static Vector4 RotateX(this Vector4 objectVertex, float angle)
        {
            return objectVertex.Translate(CreateXRotationMatrix(angle));
        }
        ...
        /// <param name="angle">Angle of rotation</param>
        /// <returns>Rotated vertex</returns>
        public static Vector4 RotateY(this Vector4 objectVertex, float angle)
        {
            return objectVertex.Translate(CreateYRotationMatrix(angle));
        }
        ...
        /// <param name="angle">Angle of rotation</param>
        /// <returns>Rotated vertex</returns>
        public static Vector4 RotateZ(this Vector4 objectVertex, float angle)
        {
            return objectVertex.Translate(CreateZRotationMatrix(angle));
        }
        ...
        public static Matrix4x4 CreateProjectionMatrix(float aspectRatio, float fov, float zFar = 100, float zNear = 1)
        {
            return new Matrix4x4
            {
                M11 = (float)(1 / (aspectRatio * Math.Tan(fov / 2))),
                M12 = 0,
                M13 = 0,
                M14 = 0,
                M21 = 0,
        ...
        public static Matrix4x4 CreateViewportMatrix(float width, float height, int xMin = 0, int yMin = 0)
        {
            return new Matrix4x4
            {
                M11 = width / 2,        M12 = 0,                    M13 = 0, M14 = 0,
                M21 = 0,                M22 = -height / 2,          M23 = 0, M24 = 0, 
                M31 = 0,                M32 = 0,                    M33 = 1, M34 = 0,
                M41 = xMin + width / 2, M42 = yMin + height / 2,    M43 = 0, M44 = 1
            };
        }
